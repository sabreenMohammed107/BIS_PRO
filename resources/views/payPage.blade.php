...
<body dir="rtl" style="text-align: right;">
   ...
   <section class="formSection"> <div class="container">
    ...
    <div class="row text-center my-5">
        ...
        <div class="col-md-8">
            <span class="text-center" style="text-align: right">استمارة تسديد الرسوم الدراسية للعام الاكاديمى 2023/2024</span>
...
<section class="formSection">
    <div class="container">
        ...
        <div class="row text-center my-5">
            ...
            <div class="col-md-8">
                <span class="text-center" style="text-align: right">تسديد الرسوم الدراسية  للعام الاكاديمى 2023/2024</span>
