...
<body dir="rtl" style="text-align: right;">
   ...
   <section class="formSection"> <div class="container">
    ...
    <div class="row text-center my-5">
        ...
        <div class="col-md-8">
            <span class="text-center" style="text-align: right">سجل بياناتك الان للتقديم فى التدريب الصيفى</span>
...
<section class="formSection">
    <div class="container">
        ...
        <form dir="rtl" action="{{ url('saveSummer') }}" method="post">
            @csrf
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  @endforeach
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-6" dir="rtl">
                        <label for="inputEmail4" dir="rtl" style="text-align:right"> الرقم القومي</label>
                        <input type="text" required class="form-control" id="inputEmail4" >
                      </div>
                      <div class="form-group col-md-6">
                        <label for="inputPassword4" dir="rtl">جهه التدريب </label>
                        <input type="text" name="summer_training_place" required class="form-control" id="inputEmail4" >
                      </div>
                    </div>
          ...
          <form dir="rtl" action="{{ url('saveSummerPdf') }}" enctype="multipart/form-data" method="post">
            @csrf
            <input type="hidden" name="paid_service_id" value="{{ $serv->id }}" >
            <input type="hidden" name="user_id" value="{{ Auth::user()->id}}" >
          <div class="row text-center my-5">
            ...
            <div class="col-md-8">
                <span class="text-center"  style="text-align: right">اذا اتممت التدريب عليك رفع الخطاب الان</span>
                <input type="file" name="summer_training_file" required class="form-control" id="inputEmail4" >
