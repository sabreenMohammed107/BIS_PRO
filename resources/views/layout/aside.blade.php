...
<div id="kt_aside" class="aside aside-default aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto pt-9 pb-5" id="kt_aside_logo">
        <!--begin::Logo-->
        <a href="#">
            <img alt="Logo" src="{{asset('web-assets/IMG/PSU pngs/image 1.png')}}" class="max-h-50px logo-default "
                style="height: 120px" />
            <img alt="Logo" src="{{asset('web-assets/IMG/PSU pngs/image 1.png')}}" class="max-h-50px logo-minimize "
                style="height: 120px" />
        </a>
        <!--end::Logo-->
    </div>
            ...
            <div class="menu-fit hover-scroll-y me-lg-n5 pe-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('paid-services.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Nav Services </span>
                            </a>
                        </div>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('student-result.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Result list</span>
                            </a>
                        </div>

                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('student-result.create') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('Pay-book-fees') }}">
                        <span class="menu-icon">
                        ...
                        <span class="menu-title">Pay book fees</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('Payment-tuition-fees') }}">
                        <span class="menu-icon">
                        ...
                        <span class="menu-title">Payment tuition fees</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('submit-petition') }}">
                        <span class="menu-icon">
                        ...
                        <span class="menu-title">submit petition
                    </a>
                </div>

                <div class="menu-item">
                    <a class="menu-link" href="{{ route('summer-training') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <span class="menu-title">summer training</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('literacy') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/abstract/abs042.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <span class="menu-title">Literacy</span>
                    </a>
                </div>
            </div>
        </div>
