...
<body dir="rtl" style="text-align: right;">
   ...
   <section class="formSection"> <div class="container">
    ...
    <div class="row text-center my-5">
        ...
        <div class="col-md-8">
            <span class="text-center" style="text-align: right">استمارة تسديد رسوم الكتب الالكترونية للعام الاكاديمى 2023/2024</span>
...
<section class="formSection">
    <div class="container">
        ...
        <form dir="rtl" action="{{ url('savePayBook') }}" method="post">
            @csrf
        ...
        <div class="row text-center my-5">
            ...
            <div class="col-md-8">
                <span class="text-center" style="text-align: right">تسديد رسوم الكتب الالكترونية للعام الاكاديمى 2023/2024</span>
