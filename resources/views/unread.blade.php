...
<body dir="rtl" style="text-align: right;">
   ...
   <section class="formSection"> <div class="container">
    ...
    <div class="row text-center my-5">
        ...
        <div class="col-md-8">
            <span class="text-center" style="text-align: right">سجل بياناتك الان للالتحاق فى قافلة محو الامية</span>
...
<section class="formSection">
    <div class="container">
        ...
        <form dir="rtl" action="{{ url('savePayPage') }}" method="post">
            @csrf
    ...
    <div class="form-row">
              <div class="form-group col-md-6" dir="rtl">
                <label for="inputEmail4" dir="rtl" style="text-align:right">رقم البطاقة</label>
                <input type="text" name="nid" class="form-control" readonly id="inputEmail4"  placeholder="Email">
              </div>
              <div class="form-group col-md-6">
                <label for="inputPassword4" dir="rtl">التليفون</label>
                <input type="text"  name="phone" class="form-control" readonly id="inputPassword4" >
              </div>
            </div>
