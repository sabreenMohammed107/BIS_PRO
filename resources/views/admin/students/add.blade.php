            ...
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{old('geloos_no')}}" name="geloos_no" class="form-control @error('geloos_no') is-invalid @enderror">
                        @error('geloos_no')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{old('nationality_id')}}" name="nationality_id" class="form-control @error('nationality_id') is-invalid @enderror">
                        ...
                        <div class="mb-3">
                            ...
                            <select required class="form-select form-select-solid dynamic"
                                ...
                                @foreach ($levels as $level)
                                    <option value="{{ $level->id }}" {{ old('level_id') == $level->id ? "selected" :""}} >{{ $level->name ?? '' }}
                                    </option>
                                @endforeach
                            </select>
                    </div>
