    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Add customer-->
                      	<!--begin::Add product-->
											<a href="{{ route('student-result.create') }}" class="btn btn-primary mx-2">Add Result</a>
     ...
     <tr>
        ...
        <td class="text-end pe-0" data-order="15">
            <input type="hidden" name="" id=""  data-kt-ecommerce-category-filter="category_id" value="{{$row->id}}" >
            <span class="fw-bolder ms-3">{{ $row->level->name ??'' }}</span>
        </td>
        <!--end::Qty=-->
        <!--begin::Price=-->
        <td class="text-end pe-0">
            <span class="fw-bolder text-dark">{{ $row->semester->semesters ?? '' }}</span>
        </td>
        <!--end::Price=-->
        <td class="text-end pe-0">
            <span class="fw-bolder text-dark">{{ $row->type->type ?? '' }}</span>
        </td>
        <td class="text-end pe-0">
            <span class="fw-bolder text-dark">{{ $row->result_value ?? '' }}</span>
        </td>
        <td class="text-end pe-0">
            <span class="fw-bolder text-dark">{{ $row->result_color ?? '' }}</span>
        </td>
          <!--begin::Price=-->
          {{-- <td class="text-end pe-0">
        ...
        <td class="text-end">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                ...
                <div class="menu-item px-3">
                    <a href="{{ route('student-result.edit', $row->id) }}"
        ...
        <form id="delete_{{$row->id}}" action="{{ route('student-result.destroy', $row->id) }}"  method="POST" style="display: none;">
        @csrf
        @method('DELETE')
